    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(typein.equals("Select")){
                    Toast.makeText(budget.this, "Select Type of Data to add", Toast.LENGTH_SHORT).show();
                    return;
                ...
                documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void avoid) {
                        ...
                        documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(budget.this, "Failled to add to all", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    public void onFailure(@NonNull Exception e) {
                        oneprog.setVisibility(View.INVISIBLE);
                        Toast.makeText(budget.this, "Failled", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        ofall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String towhere ="all";
                Intent intent=new Intent(budget.this,mainlist.class);
        ...
        fileref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(budget.this, "Failed in getting url", Toast.LENGTH_SHORT).show();
                    }
                });

                Toast.makeText(budget.this, "IMAGE UPLOADED", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(budget.this, "UPLOAD ERROOR", Toast.LENGTH_SHORT).show();
            }
        });
